        ...
        <div class="topnav">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="fortune-ber"
                        class="<?php print ($slug === 'fortune-ber') ? "nav-active-menu" : ""; ?>">ทำนายเบอร์</a></li>
                <li><a href="ber-mean"
                        class="<?php print ($slug === 'ber-mean') ? "nav-active-menu" : ""; ?>">ค้นหาเบอร์จากความหมาย</a>
                </li>
                <li><a href="howtobuy"
                        class="<?php print ($slug === 'howtobuy') ? "nav-active-menu" : ""; ?>">วิธีการสั่งซื้อ</a></li>
    ...
    <div class="container">
        <div class="text-box">
            <span>ยินดีต้อนรับเข้าสู่ Berforyou.com ศูนย์รวมจำหน่ายเบอร์สวย เบอร์มงคล เบอร์เสริมดวง
                บริการครบเครื่องเรื่องเบอร์ ระบบทำนายเบอร์อัตโนมัติ ระบบค้นหาเบอร์ที่ต้องการ ตรงจุด ทุกความต้องการ<br />
