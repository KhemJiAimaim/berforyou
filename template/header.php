...
<header>
        ...
        <nav>
            <div class="topnav">
                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="fortune-ber"
                            class="<?php print ($slug === 'fortune-ber') ? "nav-active-menu" : ""; ?>">ทำนายเบอร์</a>
                    </li>
                    <li><a href="ber-mean"
                            class="<?php print ($slug === 'ber-mean') ? "nav-active-menu" : ""; ?>">ค้นหาเบอร์จากความหมาย</a>
                    </li>
                    <li><a href="howtobuy"
                            class="<?php print ($slug === 'howtobuy') ? "nav-active-menu" : ""; ?>">วิธีการสั่งซื้อ</a>
                    </li>
                    <li><a href="delivery-check"
                            class="<?php print ($slug === 'delivery-check') ? "nav-active-menu" : ""; ?>">เช็คการจัดส่งสินค้า</a>
                    </li>
                    <li><a href="article"
                            class="<?php print ($slug === 'article') ? "nav-active-menu" : ""; ?>">บทความ</a>
                    </li>
                    <li><a href="about"
                            class="<?php print ($slug === 'about') ? "nav-active-menu" : ""; ?>">เกี่ยวกับเรา</a></li>
                    <li><a href="contact"
                            class="<?php print ($slug === 'contact') ? "nav-active-menu" : ""; ?>">ติดต่อเรา</a></li>
                    <li class="menu-cart">
                        <a href="#" class="cart">
                ...
                <div class="group-mobile-menu">
                    <div class="cart-mobile">
                        ...
                        <div class="cart-hover">
                            <ul>
                                ...
                                <li class="total-cart"><a href="cart"><i
                                            class="fas fa-cart-arrow-down"></i><span>รายการทั้งหมด</span></a></li>
                            </ul>
                            =======
                            <li>
                                <div class="top">
                    ...
                    >>>>>>> d336b4059b8947f546e16e0ad15d60ff44b910fc
                </div>

                <<<<<<< HEAD <!-- ปุ่มเมนูตอน responsive -->
                    <div class="group-mobile-menu">
                        <div class="cart-mobile">
                            <li><img href="#" class="cart" src="img/logo/solar_cart.png" alt=""></li>
                            <div class="cart-hover">
    ...
    <<<<<<< HEAD <figure><img class="bandner-nav" style="margin-top: 20px;"></figure>
        =======
                            ...
                            <div class="top-box">
                                <div class="search-number">
                                    ...
                                    <div class="analyze-number">
                                        <input type="number" data-position="0" class="search-box-num" value="0"
                                            readonly="readonly">
                                        <input type="tel" data-position="1" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="2" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="2" class="search-box-nums" value="-" required
                                            disabled>
                                        <input type="tel" data-position="3" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="4" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="5" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="2" class="search-box-nums" value="-" required
                                            disabled>
                                        <input type="tel" data-position="6" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="7" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="8" class="search-box-num" maxlength="1"
                                            placeholder="0">
                                        <input type="tel" data-position="9" class="search-box-num" maxlength="1"
                                            placeholder="0">
                            ...
                            <<<<<<< HEAD <div class="center-box">
                                ...
                                <div class="category-from">
                                    <label for="standard-select"
                                        style="color:white; font-size:16px">หมวดหมู่เบอร์</label>
                                    <div class="select">
